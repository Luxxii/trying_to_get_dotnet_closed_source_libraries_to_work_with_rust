...
*/
  ...
  void  get_values (int scanIdx, std::string method)
  {
    int val;
    MonoObject *exception;
    MonoString *str;
...
main (int argc, char *argv[])
{
  ...
  RR.setDomainName("rawrrRcpp");
  RR.createObject();
  RR.setRawFile("/tmp/sample.raw");
  RR.openFile();
  RR.get_values(1, "CentroidScan.Masses");
  RR.get_values(1, "CentroidScan.Intensities");
//  RR.createObject ();
